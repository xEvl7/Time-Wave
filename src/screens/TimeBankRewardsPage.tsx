...
export default function TimeBankRewardsPage({
  ...
  return ( 
      <View>
        ...
        <ContentContainer>
          <View>
            ...
            <Text style={{fontSize:17,fontWeight:'bold',color:'#FFFFFF',textShadowColor:'black',textShadowRadius:1,marginBottom:1}}>
             {points} Points
            </Text>
      ...
      <View style={styles.PressBackground}>
          <Pressable style={{flexDirection:"row", alignItems: 'center'}} onPress={() => navigation.navigate("MyRewardsDetailsPage")}>
            <Image style={{marginLeft:29,}}source={require("../assets/my-rewards-diamond.png")}></Image>
            <Text style={{marginLeft:5,fontSize:19}}> My Rewards Details </Text>
            <Image style={{marginLeft:'23%',}}source={require("../assets/arrow-right.png")}></Image>
          </Pressable>
        </View>  
        ...
        <View style={{flexDirection:'row',marginTop:"5%",marginLeft:"5%",justifyContent: "space-between",width: '80%',}}>
            ...
            <Pressable onPress={() => navigation.navigate("CommunityPage")}>
              <Text style={{marginTop:3,fontSize:15,fontWeight:'bold',color:'#59ADFF'}}>
                See All
              </Text>
            </Pressable>
            </View>
        ...
        <View style={{marginTop:'5%'}}>
            ...
            contentContainerStyle={{ flexGrow: 1 }} >    
              ...
              <View style={styles.gridItem}>
                ...
                <View style={styles.text}>
                  ...
                  <Text style={styles.subDescription}>Social Innovation Movement</Text>
                  <View style={styles.pointContainer}>
                    <Text style={styles.point}>{pointprice}</Text>
                    <Text style={styles.pointDesc}> points</Text>
                  </View>  
              ...
              <View style={styles.gridItem}>
                ...
                <View style={styles.text}>
                  <Text style={styles.description}>Singer Sewing Machine</Text>
                  <Text style={styles.subDescription}>Social Innovative Movement</Text>
                  <View style={styles.pointContainer}>
                    <Text style={styles.point}>{pointprice}</Text>
                    <Text style={styles.pointDesc}> points</Text>
                  </View>  
          ...
          <View style={{ flexDirection: 'row',marginTop:"5%",marginLeft:"5%",justifyContent: "space-between",width: '80%',}}>
            ...
            <Pressable onPress={() => navigation.navigate("MedicalServicesPage")}>
              <Text style={{textAlign: 'right',marginTop:5,fontSize:15,fontWeight:'bold',color:'#59ADFF'}}>
                See All
              </Text>
            </Pressable>
            </View>
